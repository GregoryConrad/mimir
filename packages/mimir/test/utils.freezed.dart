...
/// Adds pattern-matching-related methods to [ComparableMimirIndexSettings].
extension ComparableMimirIndexSettingsPatterns on ComparableMimirIndexSettings {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ComparableMimirIndexSettings value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ComparableMimirIndexSettings() when $default != null:
  ...
  TResult map<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _ComparableMimirIndexSettings():
        return $default(_that);
    }
  }
