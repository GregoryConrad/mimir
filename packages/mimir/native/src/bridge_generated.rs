...
fn wire_get_settings_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, MimirIndexSettings, _>(
        WrapInfo {
...
impl rust2dart::IntoIntoDart<MimirIndexSettings> for MimirIndexSettings {
...
impl rust2dart::IntoIntoDart<Synonyms> for Synonyms {
    fn into_into_dart(self) -> Self {
        self
    }
}
